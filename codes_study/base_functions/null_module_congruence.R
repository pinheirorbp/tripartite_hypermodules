null_module_congruence= function(NETa=NULL,NETb=NULL,MODNETa=NULL, MODNETb= NULL,M1M2= NULL, LAMBDA=0.9995,NSTEPS_MAX=50000,NSTEPS_STOP= 5000,TEMP0=4, NCores=1, Nulls=1){
